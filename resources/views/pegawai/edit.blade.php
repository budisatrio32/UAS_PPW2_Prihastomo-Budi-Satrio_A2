        ...
        <div class="mx-auto max-w-2xl">
            <form action="{{ route('pegawai.update') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="inline-flex items-center">
                            <input type="radio" name="gender" value="male" {{ old('gender', $data->gender) == 'male' ? 'checked' : '' }} required
                                class="w-4 h-4 text-[#C0392B] focus:ring-[#C0392B]">
                            <span class="ml-2 text-sm text-gray-700">Laki-laki</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="gender" value="female" {{ old('gender', $data->gender) == 'female' ? 'checked' : '' }} required
                                class="w-4 h-4 text-[#C0392B] focus:ring-[#C0392B]">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="inline-flex items-center">
                            <input type="radio" name="is_active" value="1" {{ old('is_active', $data->is_active) == '1' ? 'checked' : '' }} required
                                class="w-4 h-4 text-[#C0392B] focus:ring-[#C0392B]">
                            <span class="ml-2 text-sm text-gray-700">Aktif</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="is_active" value="0" {{ old('is_active', $data->is_active) == '0' ? 'checked' : '' }} required
                                class="w-4 h-4 text-[#C0392B] focus:ring-[#C0392B]">
